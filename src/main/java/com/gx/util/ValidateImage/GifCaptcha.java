package com.gx.util.ValidateImage;

import com.gx.util.ValidateImage.util.GifEncoder;
import com.gx.util.ValidateImage.util.Streams;

import java.awt.*;
import java.awt.image.BufferedImage;
import java.io.OutputStream;

import static com.gx.util.ValidateImage.util.Randoms.alpha;
import static com.gx.util.ValidateImage.util.Randoms.num;
